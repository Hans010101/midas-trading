...
**Approved**(2026-05-27)· 10 个决策点(D1–D10)产品方已全部拍板(见 §7.3)· 按 §7.1 分期实施中(G1 进行中)。

本文是 0009《推送通知设计》的演进(v2),**取新号 0024**,supersedes 0009 的「用户自带 bot / 双通道」模型。0009 保留作为 v1 历史记录,不就地改写。
