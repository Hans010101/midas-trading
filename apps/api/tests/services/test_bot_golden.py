...
GOLDEN: dict[str, dict[str, object]] = {'main_menu': {'text': '*点金 Midas · 迷你终端*\n\n点下方按钮选择功能 ↓\n\n也可直接发送 `/price <代码>` 查行情',
 ...
 'quote_full': {'text': '*点金 Midas · 行情*\n'
                        ...
                        '多空比(大户) 1.85\n'
                        '基差 +0.123%',
                'keyboard': {'inline_keyboard': [[{'text': '📈 K线',
                                                   'callback_data': 'qk:crypto:BTC/USDT'},
                                                  {'text': '🛒 下单',
                                                   'callback_data': 'qo:crypto:BTC/USDT'}],
                                                 [{'text': '🔄 刷新',
 ...
 'quote_min': {'text': '*点金 Midas · 行情*\n\n📊 600519 · A股\n最新价 ¥1,688\n涨跌幅 🟢 -1.20%\n成交量 98,765',
               'keyboard': {'inline_keyboard': [[{'text': '📈 K线',
                                                  'callback_data': 'qk:cn:600519'},
                                                 {'text': '🛒 下单',
                                                  'callback_data': 'qo:cn:600519'}],
                                                [{'text': '🔄 刷新',
                                                  'callback_data': 'qr:cn:600519'},
                                                 {'text': '🌐 网页K线',
 ...
 'quote_noprice': {'text': '*点金 Midas · 行情*\n\n📊 NVDA · 美股\n涨跌幅 —',
                   'keyboard': {'inline_keyboard': [[{'text': '📈 K线',
                                                      'callback_data': 'qk:us:NVDA'},
                                                     {'text': '🛒 下单',
                                                      'callback_data': 'qo:us:NVDA'}],
                                                    [{'text': '🔄 刷新',
                                                      'callback_data': 'qr:us:NVDA'},
                                                     {'text': '🌐 网页K线',
                                                      'url': 'http://localhost:3000/us-preview?symbol=NVDA'}],
                                                    [{'text': '⬅️ 返回菜单',
                                                      'callback_data': 'menu:main'}]]}},
 'quote_ask': {'text': '*点金 Midas · 查行情*\n'
                       '\n'
