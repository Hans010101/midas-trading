/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 537dec7f80e027422e4bd042cd724047)
// Runtime types generated with workerd@1.20260722.1 2026-07-26 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	ASSETS: Fetcher;
	LEGACY_API_UPSTREAM_URL: "https://api.midastrade.asia";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LEGACY_API_UPSTREAM_URL" | "AUTH_URL" | "AUTH_TRUST_HOST" | "NEXT_PUBLIC_API_URL">> {}
}
