...
export const ACADEMY_ARTICLES: AcademyArticle[] = [
  ...
  { slug: "C1-11", stage: "chan", order: 20, title: "缠论最容易误判的地方", file: "C1-11.md", excerpt: "入门概念你都懂了、C1 第一批的结构进阶也学了。但真到自己在图上画起来——为什么我画的笔和别人不一样？很多“千人千缠”的分歧，根子其实是基本功的错判。…" },
  { slug: "C1-12", stage: "chan", order: 21, title: "缠论与传统技术分析的结合", file: "C1-12.md", excerpt: "学缠论的人常陷入两个极端：要么“缠论至上、瞧不起均线 MACD”，要么“缠论太玄、回去用老办法”。客观谈一谈：缠论和传统技术分析到底是互斥还是可以配合？…" },
  { slug: "C1-13", stage: "chan", order: 22, title: "缠论术语的常见理解偏差", file: "C1-13.md", excerpt: "缠论难，一半难在“概念被误读”。很多人术语挂在嘴上、理解却是偏的——自以为懂了，其实从根上理解错了，越用越乱。给几个最常被误解的核心术语正本清源。…" },
  { slug: "C1-14", stage: "chan", order: 23, title: "用缠论完整推演一段上涨行情", file: "C1-14.md", excerpt: "概念学了一堆，这一篇把它们串起来用一遍——用一段示意的上涨行情，从最底层的 K 线，一路推演到笔、中枢、买卖点，走完缠论分析的完整流程。…" },
  { slug: "C1-15", stage: "chan", order: 24, title: "用缠论完整推演一段下跌行情", file: "C1-15.md", excerpt: "上一篇推演了上涨行情。这一篇推演下跌行情——流程完全一样，只是方向相反、买点换成卖点。和 C1-14 对照着看，更牢地掌握缠论“上下对称”的结构逻辑。…" },
  { slug: "C1-16", stage: "chan", order: 25, title: "用缠论完整推演一段盘整行情", file: "C1-16.md", excerpt: "前两篇推演了上涨和下跌（趋势）。但现实里市场大部分时间在盘整。这一篇推演一段盘整行情，重点讲盘整和趋势在缠论里的处理方式有什么本质差异。…" },
  { slug: "C1-17", stage: "chan", order: 26, title: "走势中枢的多义性", file: "C1-17.md", excerpt: "同一段走势，用 5 分钟级别看是一个样、用 30 分钟看又是另一个样——这就是缠论里的“走势 / 中枢的多义性”。它从哪来、是不是 bug、以及怎么应对？…" },
  { slug: "C1-18", stage: "chan", order: 27, title: "背驰后的三种演化", file: "C1-18.md", excerpt: "“背驰了，是不是就要反转？”这是缠论里被问得最多、也最容易做错的问题。答案很明确：不一定。把背驰之后的三种可能演化讲清楚，打破“背驰 = 反转”的执念。…" },
  { slug: "C1-19", stage: "chan", order: 28, title: "买卖点失败了怎么办", file: "C1-19.md", excerpt: "买卖点会失败——这是学缠论必须接受的事实。1 买之后继续创新低、3 买之后又跌回中枢太常见了。很多人当成“必然兑现”、一旦失败就死扛——讲怎么识别失效、怎么应对。…" },
  { slug: "C1-20", stage: "chan", order: 29, title: "缠论的概率思维", file: "C1-20.md", excerpt: "学到这里必须建立一个最重要的认知——缠论给你的是“结构和概率”，不是“必然和预测”。这一篇讲怎么用概率视角看待缠论，是整个 C1 进阶的“收心”篇。…" },
  ...
  { slug: "C2-1", stage: "contract", order: 11, title: "杠杆用得当vs用过度", file: "C2-1.md", excerpt: "老交易员常说“很多人不是输在方向上、是输在杠杆上”。这一篇用一个虚构案例，让两个看法完全相同的人，在同一段行情里用不同的杠杆，看看结局能差多远。" },
  { slug: "C2-2", stage: "contract", order: 12, title: "止损执行vs扛单", file: "C2-2.md", excerpt: "E 组讲过“止损必须设在爆仓价之前”。这一篇用示意案例，把“设了止损、按纪律走”和“不止损、扛单到爆仓”两条路并排走一遍——同样看错方向，结局可以天差地别。" },
  { slug: "C2-3", stage: "contract", order: 13, title: "资金费率如何侵蚀长期持仓", file: "C2-3.md", excerpt: "很多人做合约只盯着价格涨跌，却忘了永续合约还有一个持续在扣的成本——资金费率。用示意案例看一个“长期持有”的仓位怎么被资金费率一点点“啃掉”收益。" },
  { slug: "C2-4", stage: "contract", order: 14, title: "爆仓是怎么一步步发生的", file: "C2-4.md", excerpt: "“爆仓”大家都听过，但很多人的认识停留在“亏光了”。用示意案例把一次爆仓从开仓到强平的全过程一步步拆开——它不是突然发生，而是一步步逼近、且常比理论价更早。" },
  { slug: "C2-5", stage: "contract", order: 15, title: "震荡行情里做合约", file: "C2-5.md", excerpt: "市场大部分时间在震荡。可很多人拿着“追涨杀跌、追突破”的趋势思路去做震荡行情的合约，结果被反复“打脸”。用示意案例看这种“环境用错策略”的亏损怎么累积。" },
  { slug: "C2-6", stage: "contract", order: 16, title: "趋势行情里做合约", file: "C2-6.md", excerpt: "前面几篇多是反面教材。这篇看一个相对顺利的趋势交易案例——顺势、低杠杆、移动止损、分批止盈怎么配合。但顺利≠必然，是演示“该怎么做”，不是“这么做就一定赚”。" },
  { slug: "C2-7", stage: "contract", order: 17, title: "多空双向的运用", file: "C2-7.md", excerpt: "合约相比现货一大特点是可以双向——涨能做多、跌能做空。用示意案例看“先做空、后做多”的双向操作怎么走，顺带聊对冲思路。但双向是“更灵活”，绝不是“稳赚”。" },
