...
采集任务 · 分层节奏(ADR-0018 起合约维度全量覆盖 USDT 永续 ~527):
...
- crypto.long_short_scan         · 全量 USDT 永续 · 各取最近 4 点(覆盖 10/15min 轮间隔)
- crypto.global_overview_refresh · CoinGecko /global
- crypto.fear_greed_refresh      · alternative.me · 合并到 overview
- crypto.perp_kline_incremental  · (留 feature · 未接 beat · A1 不启用)
