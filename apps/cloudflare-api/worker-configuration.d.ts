/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example --strict-vars=false` (hash: 0f536e4ec4735f7ea4085f21b7c58fcb)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "PROJECT_NAME" | "API_VERSION" | "PUBLIC_WEB_URL" | "EMAIL_FROM" | "GOOGLE_CLIENT_ID" | "RESEND_API_KEY" | "SUPPORT_EMAIL_TO" | "PASSWORD_PEPPER" | "TELEGRAM_BOT_TOKEN" | "TELEGRAM_BOT_USERNAME" | "TELEGRAM_WEBHOOK_SECRET" | "FEISHU_APP_ID" | "FEISHU_APP_SECRET" | "FEISHU_VERIFICATION_TOKEN" | "DEEPSEEK_API_KEY">> {}
}
